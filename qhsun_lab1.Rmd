...
To maximum the difference between categories, I manually set the break according to the histogram of interpolated raster data. After that, I polygonized the raster, and clipped them by the California county boundaries.
...
terrain_plot <- ggplot() +
  ...
  labs(title = "Ground Deformation of California", fill = "Ground Deformation (Unit: mm)") +  # Legend Title
  theme(legend.position = "bottom")+
  geom_sf(data = california_counties,color = "black", fill = "transparent")+  # 绘制县边界
  geom_text(data = county_centers, aes(x = Longitude , y = Latitude, label = NAME), nudge_y = 0.1, size = 2) +
